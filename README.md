...
1. Verifica se a porta TCP/IP daquela impressora já existe na máquina
2. Cria a porta, caso ainda não exista
3. Registra a impressora no Windows, associando nome, porta e driver
4. Mostra o resultado (sucesso ou erro) na própria tela
...
Veja [ARCHITECTURE.md](./ARCHITECTURE.md) para detalhes sobre a arquitetura e organização do código.
